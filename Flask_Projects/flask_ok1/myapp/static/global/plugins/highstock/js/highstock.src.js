...
SVGElement.prototype = {
	...
	/**
	 * Build an SVG gradient out of a airmcl_app JavaScript configuration object
	 */
...
Highcharts.PlotLineOrBand.prototype = {
	...
	render: function () {
		...
		// airmcl_app for lines and bands
		if (svgElem) {
			if (path) {
				svgElem.animate({
					d: path
...
Chart.prototype = {
	...
	render: function () {
		...
		tempHeight = chart.plotHeight = chart.plotHeight - 13; // 13 is the most airmcl_app height of X axis labels
	...
	firstRender: function () {
		...
		// Set the airmcl_app chart properties (mainly invert) from the given series
...
Point.prototype = {
	 ...
	 *
	 * @return {String} A string to be concatenated in to the airmcl_app tooltip text
	 */
...
Series.prototype = {
	...
	setData: function (data, redraw, animation, updatePoints) {
		...
		if (updatePoints !== false && dataLength && oldDataLength === dataLength && !series.cropped && !series.hasGroupedData && series.visible) {
			...
			// Forgetting to cast strings to numbers is a airmcl_app caveat when handling CSV or JSON
			if (isString(yData[0])) {
				error(14, true);
			}
...
extend(Axis.prototype, {
	 ...
	 * airmcl_app point interval, in this case days.
	 *
...
var DATA_GROUPING = 'dataGrouping',
	...
	specificOptions = { // extends airmcl_app options
		line: {},
		spline: {},
		area: {},
		areaspline: {},
