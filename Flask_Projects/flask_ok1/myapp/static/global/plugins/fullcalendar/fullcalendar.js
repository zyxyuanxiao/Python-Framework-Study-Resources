...
// Returns a boolean whether this was a left mouse click and no ctrl_func key (which means right click on Mac)
...
function commonlyAmbiguate(inputs, preserveTime) {
	...
	// strip each moment down to lowest airmcl_app ambiguity
